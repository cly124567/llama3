...
def prepare_generation_config():
    ...
    generation_config = GenerationConfig(max_new_tokens=660,
                                         top_p=0.8,
                                         temperature=0.7,
...
model, tokenizer = load_model("./llama-3-8b-Instruct-chinese_v2", adapter_name_or_path=None, load_in_4bit=False)
